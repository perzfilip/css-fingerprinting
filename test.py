...
def remove_null_values(input_file, output_file):
    ...
    filtered_data = [
        record for record in cleaned_data
        if record["browser"] in {"yandex", "safari"} or "browser_version" not in record or extract_version(
            record["browser_version"]) >= 100
    ]
...
if __name__ == '__main__':
    ...
    output_file = 'browserstack_tests/browsers_cleaned_2.json'  # Change to your desired output filename
